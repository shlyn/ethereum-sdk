...
import { JsonFragment, FunctionFragment } from '@ethersProject/abi'

const PrivatePalcementABI: JsonFragment[] = [
  {
    'anonymous': false,
    'inputs': [
      {
...
export const enum PrivatePalcementFunctionName {
  CLAIM = 'claim',
...
export const enum PrivatePalcementEventName {
  CLAIMEDAMOUNT = 'ClaimedAmount',
  INITIALAMOUNTCHANGED = 'InitialAmountChanged'
}

export class PrivatePalcementContract extends BaseContract {
  claim: () => Promise<any>;
...
export function getPrivatePlacementFunction (fnName: PrivatePalcementFunctionName): FunctionFragment {
  return new ethers.utils.Interface(PrivatePalcementABI).getFunction(fnName)
}
