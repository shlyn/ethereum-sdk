...
const WyvernExchangeABI: Exclude<ContractInterface, utils.Interface> = [
  {
    'constant': true,
    'inputs': [],
    'name': 'name',
...
const enum WyvernExchangeFunctions {
  VERSION = 'version',
  ...
  ORDERSCANMATCH = 'ordersCanMatch_',
  APPROVEORDER = 'approveOrder_',
  REGISTRY = 'registry',
  ...
  INVERSEBASISPOINT = 'INVERSE_BASIS_POINT',
  CALCULATEMATCHPRICE = 'calculateMatchPrice_',
}

export {
  WyvernExchangeABI,
  WyvernExchangeFunctions
}